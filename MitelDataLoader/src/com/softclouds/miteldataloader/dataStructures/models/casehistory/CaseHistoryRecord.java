...
public class CaseHistoryRecord
{
	...
	public String getAccountDetailsOnKARecordId(String kaRecordId)
	{
		String payload = "";
		String query="SELECT acct_id, full_name FROM KMS.case_history WHERE ka_rec_id='"+kaRecordId+"';";
