...
/**
 * CreateFileAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreateFileAttachment implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for AttachmentContents
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileAttachmentContents localAttachmentContents;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localAttachmentContentsTracker = false;

	public boolean isAttachmentContentsSpecified() {
		return localAttachmentContentsTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileAttachmentContents getAttachmentContents() {
		return localAttachmentContents;
	}
	 ...
	 *            AttachmentContents
	 */
	public void setAttachmentContents(com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileAttachmentContents param) {
		localAttachmentContentsTracker = true;

		this.localAttachmentContents = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreateFileAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateFileAttachment",
						xmlWriter);
			}
		...
		if (localAttachmentContentsTracker) {
			if (localAttachmentContents == null) {

				writeStartElement(null, "urn:sbmappservices72", "attachmentContents", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localAttachmentContents.serialize(
						new javax.xml.namespace.QName("urn:sbmappservices72", "attachmentContents"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreateFileAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			CreateFileAttachment object = new CreateFileAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreateFileAttachment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreateFileAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "attachmentContents")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "attachmentContents").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setAttachmentContents(null);
						reader.next();
						...
						object.setAttachmentContents(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileAttachmentContents.Factory
										.parse(reader));
