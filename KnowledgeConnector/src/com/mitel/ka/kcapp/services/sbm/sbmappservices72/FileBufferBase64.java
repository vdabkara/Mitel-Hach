...
/**
 * FileBufferBase64 bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FileBufferBase64 implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * FileBufferBase64 Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":FileBufferBase64", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FileBufferBase64",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FileBufferBase64 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			FileBufferBase64 object = new FileBufferBase64();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FileBufferBase64".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (FileBufferBase64) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
