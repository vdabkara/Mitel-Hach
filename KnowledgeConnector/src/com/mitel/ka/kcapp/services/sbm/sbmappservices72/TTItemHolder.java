...
/**
 * TTItemHolder bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class TTItemHolder implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * TTItemHolder Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":TTItemHolder", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TTItemHolder", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TTItemHolder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TTItemHolder object = new TTItemHolder();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"TTItemHolder".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TTItemHolder) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
