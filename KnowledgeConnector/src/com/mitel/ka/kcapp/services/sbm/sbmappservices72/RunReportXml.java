...
/**
 * RunReportXml bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class RunReportXml implements org.apache.axis2.databinding.ADBBean {
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportData localReport;
	 ...
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportData
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportData getReport() {
		return localReport;
	}
	 ...
	 *            Report
	 */
	public void setReport(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportData param) {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":RunReportXml", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RunReportXml", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RunReportXml parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RunReportXml object = new RunReportXml();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"RunReportXml".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RunReportXml) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setReport(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportData.Factory.parse(reader));
