...
/**
 * GetNoteLoggerInfo bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetNoteLoggerInfo implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetNoteLoggerInfo", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetNoteLoggerInfo",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetNoteLoggerInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetNoteLoggerInfo object = new GetNoteLoggerInfo();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetNoteLoggerInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetNoteLoggerInfo) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
