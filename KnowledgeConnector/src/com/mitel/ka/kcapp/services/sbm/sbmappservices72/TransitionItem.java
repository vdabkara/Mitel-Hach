...
/**
 * TransitionItem bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class TransitionItem implements org.apache.axis2.databinding.ADBBean {
	...
	protected boolean localBreakLock = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean("true");
	 ...
	 *            BreakLock
	 */
	public void setBreakLock(boolean param) {

		this.localBreakLock = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":TransitionItem", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TransitionItem", xmlWriter);
			}
		...
		writeStartElement(null, namespace, "breakLock", xmlWriter);

		if (false) {

			throw new org.apache.axis2.databinding.ADBException("breakLock cannot be null!!");

		} else {
			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBreakLock));
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TransitionItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TransitionItem object = new TransitionItem();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"TransitionItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TransitionItem) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "breakLock").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "breakLock").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "breakLock" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setBreakLock(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
