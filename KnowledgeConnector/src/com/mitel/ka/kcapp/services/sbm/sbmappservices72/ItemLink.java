...
public class ItemLink implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = ItemLink
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemLinkType localLinkType;

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemLinkType
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemLinkType getLinkType() {
		return localLinkType;
	}
	 ...
	 *            LinkType
	 */
	public void setLinkType(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemLinkType param) {

		this.localLinkType = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ItemLink", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ItemLink", xmlWriter);
			}
		...
		if (localItemIDTracker) {
			if (localItemID == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "itemID", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localItemID.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "itemID"), xmlWriter);
			}
		}
		if (localLinkType == null) {
			throw new org.apache.axis2.databinding.ADBException("linkType cannot be null!!");
		}
		localLinkType.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "linkType"), xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ItemLink parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			ItemLink object = new ItemLink();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ItemLink".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (ItemLink) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "linkType").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "linkType").equals(reader.getName())) {

					object.setLinkType(
							com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemLinkType.Factory.parse(reader));
