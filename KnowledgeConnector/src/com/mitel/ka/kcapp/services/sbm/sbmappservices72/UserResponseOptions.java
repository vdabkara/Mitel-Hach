...
/**
 * UserResponseOptions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UserResponseOptions extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserSingleResponseOptions
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserResponseOptions Namespace URI = urn:sbmappservices72 Namespace Prefix
	 * =
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":UserResponseOptions", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UserResponseOptions",
					xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserResponseOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			UserResponseOptions object = new UserResponseOptions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserResponseOptions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (UserResponseOptions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
