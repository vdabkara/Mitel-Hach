...
/**
 * GetSolutions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetSolutions implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetSolutions", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetSolutions", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetSolutions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetSolutions object = new GetSolutions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetSolutions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetSolutions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
