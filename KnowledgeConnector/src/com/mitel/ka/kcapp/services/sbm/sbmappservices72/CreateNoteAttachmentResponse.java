...
/**
 * CreateNoteAttachmentResponse.java
 *
...
/**
 * CreateNoteAttachmentResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreateNoteAttachmentResponse implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreateNoteAttachmentResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						"CreateNoteAttachmentResponse", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreateNoteAttachmentResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			CreateNoteAttachmentResponse object = new CreateNoteAttachmentResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreateNoteAttachmentResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreateNoteAttachmentResponse) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
