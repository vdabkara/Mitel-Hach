...
/**
 * GetAvailableTransitions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetAvailableTransitions implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for TransitionOptions
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.GetTransitionOptions localTransitionOptions;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localTransitionOptionsTracker = false;

	public boolean isTransitionOptionsSpecified() {
		return localTransitionOptionsTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.GetTransitionOptions getTransitionOptions() {
	 ...
	 *            TransitionOptions
	 */
	public void setTransitionOptions(com.mitel.ka.kcapp.services.sbm.sbmappservices72.GetTransitionOptions param) {
		localTransitionOptionsTracker = param != null;

		this.localTransitionOptions = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetAvailableTransitions", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAvailableTransitions",
						xmlWriter);
			}
		...
		if (localTransitionOptionsTracker) {
			if (localTransitionOptions == null) {
				throw new org.apache.axis2.databinding.ADBException("transitionOptions cannot be null!!");
			}
			localTransitionOptions.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "transitionOptions"),
					xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetAvailableTransitions parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetAvailableTransitions object = new GetAvailableTransitions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAvailableTransitions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetAvailableTransitions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "transitionOptions")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "transitionOptions").equals(reader.getName())) {

					object.setTransitionOptions(
							com.mitel.ka.kcapp.services.sbm.sbmappservices72.GetTransitionOptions.Factory
									.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "attributeName")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "attributeName").equals(reader.getName())) {
