...
/**
 * UpdateFileAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateFileAttachment implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":UpdateFileAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UpdateFileAttachment",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UpdateFileAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			UpdateFileAttachment object = new UpdateFileAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UpdateFileAttachment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (UpdateFileAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
