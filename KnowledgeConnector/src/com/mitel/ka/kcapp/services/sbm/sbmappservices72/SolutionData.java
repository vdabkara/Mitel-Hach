...
/**
 * SolutionData bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class SolutionData implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * SolutionData Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.SolutionType localType;

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.SolutionType
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.SolutionType getType() {
		return localType;
	}
	 ...
	 *            Type
	 */
	public void setType(com.mitel.ka.kcapp.services.sbm.sbmappservices72.SolutionType param) {
	...
	/**
	 * field for ProcessAppUUID This was an Array!
	 */

	protected java.lang.String[] localProcessAppUUID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localProcessAppUUIDTracker = false;

	public boolean isProcessAppUUIDSpecified() {
		return localProcessAppUUIDTracker;
	}
	...
	public java.lang.String[] getProcessAppUUID() {
		return localProcessAppUUID;
	}

	/**
	 * validate the array for ProcessAppUUID
	 */
	protected void validateProcessAppUUID(java.lang.String[] param) {
	 ...
	 *            ProcessAppUUID
	 */
	public void setProcessAppUUID(java.lang.String[] param) {

		validateProcessAppUUID(param);

		localProcessAppUUIDTracker = param != null;

		this.localProcessAppUUID = param;
	}
	 ...
	 *            java.lang.String
	 */
	public void addProcessAppUUID(java.lang.String param) {
		if (localProcessAppUUID == null) {
			localProcessAppUUID = new java.lang.String[] {};
		}

		// update the setting tracker
		localProcessAppUUIDTracker = true;

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localProcessAppUUID);
		list.add(param);
		this.localProcessAppUUID = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":SolutionData", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SolutionData", xmlWriter);
			}
		...
		if (localProcessAppUUIDTracker) {
			if (localProcessAppUUID != null) {
				namespace = "urn:sbmappservices72";
				for (int i = 0; i < localProcessAppUUID.length; i++) {

					if (localProcessAppUUID[i] != null) {

						writeStartElement(null, namespace, "processAppUUID", xmlWriter);

						xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localProcessAppUUID[i]));
				...
				throw new org.apache.axis2.databinding.ADBException("processAppUUID cannot be null!!");
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SolutionData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			SolutionData object = new SolutionData();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SolutionData".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SolutionData) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setType(com.mitel.ka.kcapp.services.sbm.sbmappservices72.SolutionType.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "prefix").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "prefix").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "processAppUUID")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "processAppUUID").equals(reader.getName())) {
					...
					while (!loopDone5) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("urn:sbmappservices72", "processAppUUID")
									.equals(reader.getName())) {
								list5.add(reader.getElementText());
					...
					object.setProcessAppUUID((java.lang.String[]) list5.toArray(new java.lang.String[list5.size()]));
