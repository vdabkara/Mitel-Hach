...
/**
 * UserIdentifier bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UserIdentifier extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.Identifier
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserIdentifier Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":UserIdentifier", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UserIdentifier", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserIdentifier parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			UserIdentifier object = new UserIdentifier();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserIdentifier".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (UserIdentifier) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "loginId").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "loginId").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setLoginId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
