...
/**
 * UserHolder bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UserHolder implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserHolder Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserInfo localUser;
	 ...
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserInfo
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserInfo getUser() {
		return localUser;
	}
	 ...
	 *            User
	 */
	public void setUser(com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserInfo param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":UserHolder", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UserHolder", xmlWriter);
			}
		...
		if (localUserTracker) {
			if (localUser == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "user", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localUser.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "user"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserHolder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			UserHolder object = new UserHolder();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserHolder".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (UserHolder) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setUser(com.mitel.ka.kcapp.services.sbm.sbmappservices72.UserInfo.Factory.parse(reader));
