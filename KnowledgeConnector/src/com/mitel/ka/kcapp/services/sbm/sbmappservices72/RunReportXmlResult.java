...
/**
 * RunReportXmlResult bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class RunReportXmlResult implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * RunReportXmlResult Namespace URI = urn:sbmappservices72 Namespace Prefix
	 * =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":RunReportXmlResult", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RunReportXmlResult",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RunReportXmlResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RunReportXmlResult object = new RunReportXmlResult();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"RunReportXmlResult".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RunReportXmlResult) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
