...
/**
 * IsUserValid bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class IsUserValid implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":IsUserValid", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "IsUserValid", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static IsUserValid parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			IsUserValid object = new IsUserValid();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"IsUserValid".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (IsUserValid) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
