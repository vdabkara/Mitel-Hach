...
/**
 * MultipleResponseItemOptions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class MultipleResponseItemOptions extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.ResponseItemOptions
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MultipleResponseItemOptions Namespace URI = urn:sbmappservices72
	 * Namespace Prefix =
	 */

	/**
	 * field for MultiOption
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.MultipleOption localMultiOption;
	 ...
	 */
	protected boolean localMultiOptionTracker = false;

	public boolean isMultiOptionSpecified() {
		return localMultiOptionTracker;
	}

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.MultipleOption
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.MultipleOption getMultiOption() {
		return localMultiOption;
	}
	 ...
	 *            MultiOption
	 */
	public void setMultiOption(com.mitel.ka.kcapp.services.sbm.sbmappservices72.MultipleOption param) {
		localMultiOptionTracker = param != null;

		this.localMultiOption = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":MultipleResponseItemOptions", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "MultipleResponseItemOptions",
					xmlWriter);
		}
		...
		if (localMultiOptionTracker) {
			if (localMultiOption == null) {
				throw new org.apache.axis2.databinding.ADBException("multiOption cannot be null!!");
			}
			localMultiOption.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "multiOption"), xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MultipleResponseItemOptions parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MultipleResponseItemOptions object = new MultipleResponseItemOptions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"MultipleResponseItemOptions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (MultipleResponseItemOptions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "multiOption").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "multiOption").equals(reader.getName())) {

					object.setMultiOption(
							com.mitel.ka.kcapp.services.sbm.sbmappservices72.MultipleOption.Factory.parse(reader));
