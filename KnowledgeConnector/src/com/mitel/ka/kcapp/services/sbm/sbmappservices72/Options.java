...
public class Options implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Options
	 * Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */

	/**
	 * field for ExtraOption This was an Array!
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[] localExtraOption;
	 ...
	 */
	protected boolean localExtraOptionTracker = false;

	public boolean isExtraOptionSpecified() {
		return localExtraOptionTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[] getExtraOption() {
		return localExtraOption;
	}

	/**
	 * validate the array for ExtraOption
	 */
	protected void validateExtraOption(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[] param) {
	 ...
	 *            ExtraOption
	 */
	public void setExtraOption(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[] param) {

		validateExtraOption(param);

		localExtraOptionTracker = param != null;

		this.localExtraOption = param;
	}
	 ...
	 */
	public void addExtraOption(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue param) {
		if (localExtraOption == null) {
			localExtraOption = new com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[] {};
		}

		// update the setting tracker
		localExtraOptionTracker = true;

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localExtraOption);
		list.add(param);
		this.localExtraOption = (com.mitel.ka.kcapp.services.sbm.sbmappservices72.ExtraValue[]) list
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Options".equals(type)) {
							...
							return (Options) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
