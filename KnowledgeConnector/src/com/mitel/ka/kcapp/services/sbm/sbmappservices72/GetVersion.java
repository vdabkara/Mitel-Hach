...
/**
 * GetVersion bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetVersion implements org.apache.axis2.databinding.ADBBean {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetVersion".equals(type)) {
							...
							return (GetVersion) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
