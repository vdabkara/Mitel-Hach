...
/**
 * ApplicationData bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ApplicationData implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ApplicationData Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ApplicationIdentifier localApplication;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ApplicationIdentifier getApplication() {
	 ...
	 *            Application
	 */
	public void setApplication(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ApplicationIdentifier param) {
	...
	/**
	 * field for AppDefUUID
	 */

	protected java.lang.String localAppDefUUID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localAppDefUUIDTracker = false;

	public boolean isAppDefUUIDSpecified() {
		return localAppDefUUIDTracker;
	}
	 ...
	 *            AppDefUUID
	 */
	public void setAppDefUUID(java.lang.String param) {
		localAppDefUUIDTracker = true;

		this.localAppDefUUID = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ApplicationData", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ApplicationData",
						xmlWriter);
			}
		...
		if (localApplicationTracker) {
			if (localApplication == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "application", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localApplication.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "application"),
						xmlWriter);
			}
		}
		...
		if (localAppDefUUIDTracker) {
			namespace = "urn:sbmappservices72";
			writeStartElement(null, namespace, "appDefUUID", xmlWriter);

			if (localAppDefUUID == null) {
				// write the nil attribute
				...
				xmlWriter.writeCharacters(localAppDefUUID);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ApplicationData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			ApplicationData object = new ApplicationData();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ApplicationData".equals(type)) {
							...
							return (ApplicationData) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "application").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "application").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setApplication(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.ApplicationIdentifier.Factory
										.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "appDefUUID").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "appDefUUID").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setAppDefUUID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "revision").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "revision").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setRevision(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
