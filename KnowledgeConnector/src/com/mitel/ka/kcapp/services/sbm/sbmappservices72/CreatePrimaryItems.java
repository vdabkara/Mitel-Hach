...
/**
 * CreatePrimaryItems bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreatePrimaryItems implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreatePrimaryItems", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreatePrimaryItems",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreatePrimaryItems parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			CreatePrimaryItems object = new CreatePrimaryItems();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreatePrimaryItems".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreatePrimaryItems) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					list4.add(com.mitel.ka.kcapp.services.sbm.sbmappservices72.TTItem.Factory.parse(reader));
