...
/**
 * CreatePrimaryItem bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreatePrimaryItem implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for ParentItem
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier localParentItem;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localParentItemTracker = false;

	public boolean isParentItemSpecified() {
		return localParentItemTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier getParentItem() {
		return localParentItem;
	}
	 ...
	 *            ParentItem
	 */
	public void setParentItem(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier param) {
		localParentItemTracker = true;

		this.localParentItem = param;
	...
	/**
	 * field for SubmitTransition
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier localSubmitTransition;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localSubmitTransitionTracker = false;

	public boolean isSubmitTransitionSpecified() {
		return localSubmitTransitionTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier getSubmitTransition() {
		return localSubmitTransition;
	}
	 ...
	 *            SubmitTransition
	 */
	public void setSubmitTransition(com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier param) {
		localSubmitTransitionTracker = true;

		this.localSubmitTransition = param;
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ResponseItemOptions localOptions;
	 ...
	 *         ResponseItemOptions
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ResponseItemOptions getOptions() {
		return localOptions;
	}
	 ...
	 *            Options
	 */
	public void setOptions(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ResponseItemOptions param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreatePrimaryItem", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreatePrimaryItem",
						xmlWriter);
			}
		...
		if (localParentItemTracker) {
			if (localParentItem == null) {

				writeStartElement(null, "urn:sbmappservices72", "parentItem", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localParentItem.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "parentItem"),
						xmlWriter);
			}
		}
		if (localItem == null) {
		...
		if (localSubmitTransitionTracker) {
			if (localSubmitTransition == null) {

				writeStartElement(null, "urn:sbmappservices72", "submitTransition", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localSubmitTransition.serialize(
						new javax.xml.namespace.QName("urn:sbmappservices72", "submitTransition"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreatePrimaryItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			CreatePrimaryItem object = new CreatePrimaryItem();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreatePrimaryItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreatePrimaryItem) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "parentItem").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "parentItem").equals(reader.getName())) {
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setItem(com.mitel.ka.kcapp.services.sbm.sbmappservices72.TTItem.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "submitTransition")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "submitTransition").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setSubmitTransition(null);
						reader.next();
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setOptions(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ResponseItemOptions.Factory
								.parse(reader));
