...
public class Status implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Status
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.StatusEnum localStatus;

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.StatusEnum
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.StatusEnum getStatus() {
		return localStatus;
	}
	 ...
	 *            Status
	 */
	public void setStatus(com.mitel.ka.kcapp.services.sbm.sbmappservices72.StatusEnum param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Status",
						xmlWriter);
			} else {
		...
		localStatus.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "status"), xmlWriter);
		if (localCodeTracker) {
		...
		public static Status parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Status".equals(type)) {
							...
							return (Status) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setStatus(com.mitel.ka.kcapp.services.sbm.sbmappservices72.StatusEnum.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "code").equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "message").equals(reader.getName())
