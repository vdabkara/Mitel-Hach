...
/**
 * WorkflowComment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class WorkflowComment implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * WorkflowComment Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.Point localCenter;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.Point getCenter() {
		return localCenter;
	}
	 ...
	 *            Center
	 */
	public void setCenter(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Point param) {
		localCenterTracker = true;
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.Size localSize;
	 ...
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.Size
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.Size getSize() {
		return localSize;
	}
	 ...
	 *            Size
	 */
	public void setSize(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Size param) {
	...
	/**
	 * field for OwnerTransition
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier localOwnerTransition;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localOwnerTransitionTracker = false;

	public boolean isOwnerTransitionSpecified() {
		return localOwnerTransitionTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier getOwnerTransition() {
		return localOwnerTransition;
	}
	 ...
	 *            OwnerTransition
	 */
	public void setOwnerTransition(com.mitel.ka.kcapp.services.sbm.sbmappservices72.TransitionIdentifier param) {
		localOwnerTransitionTracker = true;

		this.localOwnerTransition = param;

	}

	/**
	 * field for OwnerState
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier localOwnerState;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localOwnerStateTracker = false;

	public boolean isOwnerStateSpecified() {
		return localOwnerStateTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier getOwnerState() {
	 ...
	 *            OwnerState
	 */
	public void setOwnerState(com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier param) {
		localOwnerStateTracker = true;

		this.localOwnerState = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":WorkflowComment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "WorkflowComment",
						xmlWriter);
			}
		...
		if (localCenterTracker) {
			if (localCenter == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "center", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localCenter.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "center"), xmlWriter);
			}
		}
		if (localSizeTracker) {
			if (localSize == null) {

				writeStartElement(null, "urn:sbmappservices72", "size", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localSize.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "size"), xmlWriter);
			}
		}
		if (localTextTracker) {
			namespace = "urn:sbmappservices72";
		...
		if (localOwnerTransitionTracker) {
			if (localOwnerTransition == null) {

				writeStartElement(null, "urn:sbmappservices72", "ownerTransition", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localOwnerTransition.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "ownerTransition"),
						xmlWriter);
			}
		}
		if (localOwnerStateTracker) {
			if (localOwnerState == null) {

				writeStartElement(null, "urn:sbmappservices72", "ownerState", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localOwnerState.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "ownerState"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static WorkflowComment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			WorkflowComment object = new WorkflowComment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"WorkflowComment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (WorkflowComment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "center").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "center").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setCenter(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Point.Factory.parse(reader));
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setSize(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Size.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "text").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "text").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "ownerTransition")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "ownerTransition").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setOwnerTransition(null);
						reader.next();
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "ownerState").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "ownerState").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setOwnerState(null);
						reader.next();
