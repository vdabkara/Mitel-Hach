...
/**
 * GetFileAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetFileAttachment implements org.apache.axis2.databinding.ADBBean {
	...
	protected java.math.BigInteger localAttachmentID;
	 ...
	 *            AttachmentID
	 */
	public void setAttachmentID(java.math.BigInteger param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetFileAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetFileAttachment",
						xmlWriter);
			}
		...
		writeStartElement(null, namespace, "attachmentID", xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetFileAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetFileAttachment object = new GetFileAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetFileAttachment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetFileAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "attachmentID")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "attachmentID").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "attachmentID" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setAttachmentID(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
