...
/**
 * TableIdentifier bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class TableIdentifier extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.Identifier
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * TableIdentifier Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":TableIdentifier", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TableIdentifier", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TableIdentifier parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TableIdentifier object = new TableIdentifier();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"TableIdentifier".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TableIdentifier) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "dbName").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "dbName").equals(reader.getName())) {
