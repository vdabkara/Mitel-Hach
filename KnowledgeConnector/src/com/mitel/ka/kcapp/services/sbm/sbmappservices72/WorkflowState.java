...
/**
 * WorkflowState bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class WorkflowState implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * WorkflowState Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier localId;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier getId() {
		return localId;
	}
	 ...
	 *            Id
	 */
	public void setId(com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier param) {
		localIdTracker = true;
	...
	protected java.math.BigInteger localRadius;
	 ...
	 *            Radius
	 */
	public void setRadius(java.math.BigInteger param) {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":WorkflowState", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "WorkflowState", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static WorkflowState parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			WorkflowState object = new WorkflowState();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"WorkflowState".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (WorkflowState) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "radius").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "radius").equals(reader.getName())) {
					...
					object.setRadius(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
