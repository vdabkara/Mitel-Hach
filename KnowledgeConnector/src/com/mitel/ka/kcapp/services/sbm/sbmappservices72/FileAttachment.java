...
/**
 * FileAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FileAttachment implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * FileAttachment Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	/**
	 * field for ShowAsImage
	 */

	protected boolean localShowAsImage;
	 ...
	 *            ShowAsImage
	 */
	public void setShowAsImage(boolean param) {

		this.localShowAsImage = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":FileAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FileAttachment", xmlWriter);
			}
		...
		namespace = "urn:sbmappservices72";
		writeStartElement(null, namespace, "showAsImage", xmlWriter);

		if (false) {

			throw new org.apache.axis2.databinding.ADBException("showAsImage cannot be null!!");

		} else {
			xmlWriter.writeCharacters(
					org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localShowAsImage));
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FileAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			FileAttachment object = new FileAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FileAttachment".equals(type)) {
							...
							return (FileAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "name").equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "fileName").equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "showAsImage").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "showAsImage").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "showAsImage" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setShowAsImage(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
