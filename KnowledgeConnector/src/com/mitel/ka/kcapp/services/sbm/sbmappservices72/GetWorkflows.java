...
/**
 * GetWorkflows bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetWorkflows implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for Project This was an Array!
	 */
	 ...
	 */
	protected void validateProject(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier[] param) {
	 ...
	 *            ProjectIdentifier
	 */
	public void addProject(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier param) {
		if (localProject == null) {
			localProject = new com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier[] {};
		}

		// update the setting tracker
		localProjectTracker = true;

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localProject);
		list.add(param);
		this.localProject = (com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier[]) list
				.toArray(new com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier[list.size()]);
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetWorkflows", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetWorkflows", xmlWriter);
			}
			...
			if (localProject != null) {
				for (int i = 0; i < localProject.length; i++) {
					if (localProject[i] != null) {
						localProject[i].serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "project"),
								xmlWriter);
					} else {
	...
	public static class Factory {
		...
		public static GetWorkflows parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetWorkflows object = new GetWorkflows();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetWorkflows".equals(type)) {
							...
							return (GetWorkflows) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					list2.add(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier.Factory.parse(reader));
					...
					while (!loopDone2) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("urn:sbmappservices72", "project")
									.equals(reader.getName())) {
								list2.add(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier.Factory
										.parse(reader));
					...
					object.setProject(
							(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier[]) org.apache.axis2.databinding.utils.ConverterUtil
									.convertToArray(
											com.mitel.ka.kcapp.services.sbm.sbmappservices72.ProjectIdentifier.class,
											list2));
