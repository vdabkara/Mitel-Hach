...
/**
 * Identifier bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class Identifier implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * Identifier Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":Identifier", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Identifier", xmlWriter);
			}
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Identifier".equals(type)) {
							...
							return (Identifier) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
