...
/**
 * GetStateChangeHistory bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetStateChangeHistory implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetStateChangeHistory", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetStateChangeHistory",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetStateChangeHistory parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetStateChangeHistory object = new GetStateChangeHistory();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetStateChangeHistory".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetStateChangeHistory) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
