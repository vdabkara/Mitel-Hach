...
/**
 * SelectionOption bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class SelectionOption implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * SelectionOption Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	/**
	 * field for OrderIndex
	 */

	protected java.math.BigInteger localOrderIndex;
	 ...
	 */
	public java.math.BigInteger getOrderIndex() {
		return localOrderIndex;
	}
	 ...
	 *            OrderIndex
	 */
	public void setOrderIndex(java.math.BigInteger param) {

		this.localOrderIndex = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":SelectionOption", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SelectionOption",
						xmlWriter);
			}
		...
		writeStartElement(null, namespace, "orderIndex", xmlWriter);

		if (localOrderIndex == null) {
			// write the nil attribute

			throw new org.apache.axis2.databinding.ADBException("orderIndex cannot be null!!");

		} else {

			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrderIndex));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SelectionOption parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			SelectionOption object = new SelectionOption();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SelectionOption".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SelectionOption) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "orderIndex").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "orderIndex").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "orderIndex" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setOrderIndex(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
