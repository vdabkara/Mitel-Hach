...
/**
 * CreateAuxItem bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreateAuxItem implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreateAuxItem", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateAuxItem", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreateAuxItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			CreateAuxItem object = new CreateAuxItem();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreateAuxItem".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreateAuxItem) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
