...
/**
 * ProjectData bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ProjectData implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ProjectData Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ProjectData", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ProjectData", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ProjectData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ProjectData".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (ProjectData) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
