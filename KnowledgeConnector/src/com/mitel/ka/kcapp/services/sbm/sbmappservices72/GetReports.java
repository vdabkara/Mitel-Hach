...
/**
 * GetReports bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetReports implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for ReportsFilter
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportsFilter localReportsFilter;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localReportsFilterTracker = false;

	public boolean isReportsFilterSpecified() {
		return localReportsFilterTracker;
	}

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportsFilter
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportsFilter getReportsFilter() {
		return localReportsFilter;
	}
	 ...
	 *            ReportsFilter
	 */
	public void setReportsFilter(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportsFilter param) {
		localReportsFilterTracker = true;

		this.localReportsFilter = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetReports", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetReports", xmlWriter);
			}
		...
		if (localReportsFilterTracker) {
			if (localReportsFilter == null) {

				writeStartElement(null, "urn:sbmappservices72", "reportsFilter", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localReportsFilter.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "reportsFilter"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetReports parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetReports object = new GetReports();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetReports".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetReports) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "reportsFilter")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "reportsFilter").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setReportsFilter(null);
						reader.next();
						...
						object.setReportsFilter(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.ReportsFilter.Factory.parse(reader));
