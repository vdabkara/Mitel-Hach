...
/**
 * URLAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class URLAttachment implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * URLAttachment Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":URLAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "URLAttachment", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static URLAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			URLAttachment object = new URLAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"URLAttachment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (URLAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
