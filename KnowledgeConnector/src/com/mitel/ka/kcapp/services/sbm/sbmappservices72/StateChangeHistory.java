...
/**
 * StateChangeHistory bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class StateChangeHistory implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * StateChangeHistory Namespace URI = urn:sbmappservices72 Namespace Prefix
	 * =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier localNewState;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier getNewState() {
	 ...
	 *            NewState
	 */
	public void setNewState(com.mitel.ka.kcapp.services.sbm.sbmappservices72.StateIdentifier param) {
		localNewStateTracker = true;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":StateChangeHistory", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "StateChangeHistory",
						xmlWriter);
			}
		...
		if (localNewStateTracker) {
			if (localNewState == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "newState", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localNewState.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "newState"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static StateChangeHistory parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			StateChangeHistory object = new StateChangeHistory();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"StateChangeHistory".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (StateChangeHistory) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "newState").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "newState").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setNewState(null);
						reader.next();
				...
				if (reader.isStartElement()
					...
					object.setTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(content));
