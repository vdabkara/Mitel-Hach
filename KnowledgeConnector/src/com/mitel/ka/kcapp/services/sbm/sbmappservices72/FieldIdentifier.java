...
/**
 * FieldIdentifier bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FieldIdentifier extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.Identifier
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * FieldIdentifier Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":FieldIdentifier", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FieldIdentifier", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FieldIdentifier parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FieldIdentifier".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (FieldIdentifier) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
