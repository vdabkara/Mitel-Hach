...
public class Auth implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for LoginAsUserId
	 */

	protected java.lang.String localLoginAsUserId;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localLoginAsUserIdTracker = false;

	public boolean isLoginAsUserIdSpecified() {
		return localLoginAsUserIdTracker;
	}
	 ...
	 *            LoginAsUserId
	 */
	public void setLoginAsUserId(java.lang.String param) {
		localLoginAsUserIdTracker = true;

		this.localLoginAsUserId = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Auth",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Auth", xmlWriter);
			}
		...
		if (localLoginAsUserIdTracker) {
			namespace = "urn:sbmappservices72";
			writeStartElement(null, namespace, "loginAsUserId", xmlWriter);

			if (localLoginAsUserId == null) {
				// write the nil attribute
				...
				xmlWriter.writeCharacters(localLoginAsUserId);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static Auth parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Auth".equals(type)) {
							...
							return (Auth) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "userId").equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "password").equals(reader.getName())
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "hostname").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "hostname").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "loginAsUserId")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "loginAsUserId").equals(reader.getName())) {
