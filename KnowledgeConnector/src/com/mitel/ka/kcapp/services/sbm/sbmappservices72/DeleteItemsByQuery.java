...
/**
 * DeleteItemsByQuery bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class DeleteItemsByQuery implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":DeleteItemsByQuery", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteItemsByQuery",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static DeleteItemsByQuery parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			DeleteItemsByQuery object = new DeleteItemsByQuery();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"DeleteItemsByQuery".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (DeleteItemsByQuery) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
