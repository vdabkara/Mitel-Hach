...
/**
 * FileAttachmentContents bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FileAttachmentContents extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileAttachment
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * FileAttachmentContents Namespace URI = urn:sbmappservices72 Namespace
	 * Prefix =
	 */

	/**
	 * field for ContentsBase64
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileBufferBase64 localContentsBase64;
	 ...
	 */
	protected boolean localContentsBase64Tracker = false;

	public boolean isContentsBase64Specified() {
		return localContentsBase64Tracker;
	}

	/**
	 * Auto generated getter method
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileBufferBase64
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileBufferBase64 getContentsBase64() {
		return localContentsBase64;
	}
	 ...
	 *            ContentsBase64
	 */
	public void setContentsBase64(com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileBufferBase64 param) {
		localContentsBase64Tracker = true;

		this.localContentsBase64 = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":FileAttachmentContents", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FileAttachmentContents",
					xmlWriter);
		}
		...
		if (localContentsBase64Tracker) {
			if (localContentsBase64 == null) {

				writeStartElement(null, "urn:sbmappservices72", "contentsBase64", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localContentsBase64.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "contentsBase64"),
						xmlWriter);
			}
		}
		xmlWriter.writeEndElement();
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FileAttachmentContents parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			FileAttachmentContents object = new FileAttachmentContents();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FileAttachmentContents".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (FileAttachmentContents) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "contentsBase64")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "contentsBase64").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setContentsBase64(null);
						reader.next();
						...
						object.setContentsBase64(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.FileBufferBase64.Factory
										.parse(reader));
