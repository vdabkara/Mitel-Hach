...
/**
 * NoteLoggerInfo bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class NoteLoggerInfo implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * NoteLoggerInfo Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":NoteLoggerInfo", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NoteLoggerInfo", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NoteLoggerInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			NoteLoggerInfo object = new NoteLoggerInfo();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"NoteLoggerInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (NoteLoggerInfo) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "emailAddress")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "emailAddress").equals(reader.getName())) {
