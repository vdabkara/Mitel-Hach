...
public class ReportDefinition implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ReportDefinition Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.OrderBy localOrderBy;
	 ...
	 * 
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.OrderBy
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.OrderBy getOrderBy() {
		return localOrderBy;
	}
	 ...
	 *            OrderBy
	 */
	public void setOrderBy(com.mitel.ka.kcapp.services.sbm.sbmappservices72.OrderBy param) {
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[] localColumn;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[] getColumn() {
		return localColumn;
	}
	 ...
	 */
	protected void validateColumn(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[] param) {
	 ...
	 *            Column
	 */
	public void setColumn(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[] param) {
	 ...
	 */
	public void addColumn(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field param) {
		if (localColumn == null) {
			localColumn = new com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[] {};
		}
		...
		list.add(param);
		this.localColumn = (com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field[]) list
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ReportDefinition", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ReportDefinition",
						xmlWriter);
			}
		...
		if (localOrderByTracker) {
			if (localOrderBy == null) {
				...
				writeStartElement(null, "urn:sbmappservices72", "orderBy", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localOrderBy.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "orderBy"), xmlWriter);
			}
		}
			...
			if (localColumn != null) {
				for (int i = 0; i < localColumn.length; i++) {
					if (localColumn[i] != null) {
						localColumn[i].serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "column"),
								xmlWriter);
					} else {
		...
		public static ReportDefinition parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ReportDefinition".equals(type)) {
							...
							return (ReportDefinition) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "orderBy").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "orderBy").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setOrderBy(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.OrderBy.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "column").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "column").equals(reader.getName())) {

					// Process the array and step past its final element's end.

					list2.add(com.mitel.ka.kcapp.services.sbm.sbmappservices72.Field.Factory.parse(reader));
					...
					while (!loopDone2) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("urn:sbmappservices72", "column")
