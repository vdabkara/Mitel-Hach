...
/**
 * QueryRange bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class QueryRange implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * QueryRange Namespace URI = urn:sbmappservices72 Namespace Prefix =
	 */
	...
	public void setStartIndex(java.math.BigInteger param) {
		localStartIndexTracker = param != null;
	...
	protected java.math.BigInteger localFetchSize;
	 ...
	 *            FetchSize
	 */
	public void setFetchSize(java.math.BigInteger param) {
		localFetchSizeTracker = param != null;
	...
	public void setTotalCount(java.math.BigInteger param) {
		localTotalCountTracker = param != null;
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":QueryRange", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "QueryRange", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static QueryRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			QueryRange object = new QueryRange();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"QueryRange".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (QueryRange) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "startIndex").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "startIndex").equals(reader.getName())) {
					...
					object.setStartIndex(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "fetchSize").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "fetchSize").equals(reader.getName())) {
					...
					object.setFetchSize(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
