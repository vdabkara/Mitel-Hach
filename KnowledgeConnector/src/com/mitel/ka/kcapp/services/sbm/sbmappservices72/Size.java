...
public class Size implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Size
	...
	protected java.math.BigInteger localWidth;
	 ...
	 *            Width
	 */
	public void setWidth(java.math.BigInteger param) {
	...
	protected java.math.BigInteger localHeight;
	 ...
	 *            Height
	 */
	public void setHeight(java.math.BigInteger param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Size",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Size", xmlWriter);
			}
		...
		public static Size parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Size".equals(type)) {
							...
							return (Size) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "width").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "width").equals(reader.getName())) {
					...
					object.setWidth(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "height").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "height").equals(reader.getName())) {
					...
					object.setHeight(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
