...
/**
 * GetAvailableSubmitTransitions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetAvailableSubmitTransitions implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetAvailableSubmitTransitions", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAvailableSubmitTransitions", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetAvailableSubmitTransitions parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetAvailableSubmitTransitions object = new GetAvailableSubmitTransitions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAvailableSubmitTransitions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetAvailableSubmitTransitions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
