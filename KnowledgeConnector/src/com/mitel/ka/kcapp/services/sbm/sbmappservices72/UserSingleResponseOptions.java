...
/**
 * UserSingleResponseOptions.java
 *
...
/**
 * UserSingleResponseOptions bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UserSingleResponseOptions extends com.mitel.ka.kcapp.services.sbm.sbmappservices72.Options
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserSingleResponseOptions Namespace URI = urn:sbmappservices72 Namespace
	 * Prefix =
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":UserSingleResponseOptions", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UserSingleResponseOptions",
					xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserSingleResponseOptions parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			UserSingleResponseOptions object = new UserSingleResponseOptions();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserSingleResponseOptions".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (UserSingleResponseOptions) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
