...
public class DeleteAttachmentResponse implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":DeleteAttachmentResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteAttachmentResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static DeleteAttachmentResponse parse(javax.xml.stream.XMLStreamReader reader)
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"DeleteAttachmentResponse".equals(type)) {
							...
							return (DeleteAttachmentResponse) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
