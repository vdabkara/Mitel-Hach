...
/**
 * IsUserValidResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class IsUserValidResponse implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":IsUserValidResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "IsUserValidResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static IsUserValidResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			IsUserValidResponse object = new IsUserValidResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"IsUserValidResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (IsUserValidResponse) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
