...
public class Point implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Point
	...
	protected java.math.BigInteger localX;
	 ...
	 *            X
	 */
	public void setX(java.math.BigInteger param) {
	...
	protected java.math.BigInteger localY;
	 ...
	 *            Y
	 */
	public void setY(java.math.BigInteger param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Point",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Point", xmlWriter);
			}
		...
		public static Point parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Point".equals(type)) {
							...
							return (Point) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "x").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "x").equals(reader.getName())) {
					...
					object.setX(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "y").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "y").equals(reader.getName())) {
					...
					object.setY(org.apache.axis2.databinding.utils.ConverterUtil.convertToInteger(content));
