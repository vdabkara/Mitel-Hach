...
/**
 * LinkSubtask bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class LinkSubtask implements org.apache.axis2.databinding.ADBBean {
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier localChildItem;
	 ...
	 * @return com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier getChildItem() {
	 ...
	 *            ChildItem
	 */
	public void setChildItem(com.mitel.ka.kcapp.services.sbm.sbmappservices72.ItemIdentifier param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":LinkSubtask", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "LinkSubtask", xmlWriter);
			}
		...
		if (localParentItem == null) {
			...
			localParentItem.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "parentItem"), xmlWriter);
		}

		if (localChildItem == null) {

			writeStartElement(null, "urn:sbmappservices72", "childItem", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localChildItem.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "childItem"), xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static LinkSubtask parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			LinkSubtask object = new LinkSubtask();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"LinkSubtask".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (LinkSubtask) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "childItem").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "childItem").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setChildItem(null);
						reader.next();
