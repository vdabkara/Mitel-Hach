...
/**
 * CreateNoteAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class CreateNoteAttachment implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for NoteContents
	 */

	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.NoteAttachmentContents localNoteContents;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localNoteContentsTracker = false;

	public boolean isNoteContentsSpecified() {
		return localNoteContentsTracker;
	}
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.NoteAttachmentContents getNoteContents() {
		return localNoteContents;
	}
	 ...
	 *            NoteContents
	 */
	public void setNoteContents(com.mitel.ka.kcapp.services.sbm.sbmappservices72.NoteAttachmentContents param) {
		localNoteContentsTracker = true;

		this.localNoteContents = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":CreateNoteAttachment", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateNoteAttachment",
						xmlWriter);
			}
		...
		if (localNoteContentsTracker) {
			if (localNoteContents == null) {

				writeStartElement(null, "urn:sbmappservices72", "noteContents", xmlWriter);

				// write the nil attribute
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localNoteContents.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "noteContents"),
						xmlWriter);
			}
		}
		xmlWriter.writeEndElement();
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CreateNoteAttachment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			CreateNoteAttachment object = new CreateNoteAttachment();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CreateNoteAttachment".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (CreateNoteAttachment) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "noteContents")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "noteContents").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setNoteContents(null);
						reader.next();
						...
						object.setNoteContents(
								com.mitel.ka.kcapp.services.sbm.sbmappservices72.NoteAttachmentContents.Factory
										.parse(reader));
