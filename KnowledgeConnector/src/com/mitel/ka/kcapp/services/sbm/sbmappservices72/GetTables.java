...
/**
 * GetTables bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetTables implements org.apache.axis2.databinding.ADBBean {
	...
	protected com.mitel.ka.kcapp.services.sbm.sbmappservices72.TableType localTableType;
	 ...
	 */
	public com.mitel.ka.kcapp.services.sbm.sbmappservices72.TableType getTableType() {
	 ...
	 *            TableType
	 */
	public void setTableType(com.mitel.ka.kcapp.services.sbm.sbmappservices72.TableType param) {

		this.localTableType = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetTables", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetTables", xmlWriter);
			}
		...
		if (localTableType == null) {
			throw new org.apache.axis2.databinding.ADBException("tableType cannot be null!!");
		}
		localTableType.serialize(new javax.xml.namespace.QName("urn:sbmappservices72", "tableType"), xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetTables parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetTables object = new GetTables();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetTables".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetTables) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("urn:sbmappservices72", "tableType").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "tableType").equals(reader.getName())) {

					object.setTableType(
							com.mitel.ka.kcapp.services.sbm.sbmappservices72.TableType.Factory.parse(reader));
