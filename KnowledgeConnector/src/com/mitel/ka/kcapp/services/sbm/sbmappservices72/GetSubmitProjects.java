...
/**
 * GetSubmitProjects bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetSubmitProjects implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":GetSubmitProjects", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetSubmitProjects",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetSubmitProjects parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			GetSubmitProjects object = new GetSubmitProjects();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetSubmitProjects".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (GetSubmitProjects) com.mitel.ka.kcapp.services.sbm.serenadiagnostics.ExtensionMapper
